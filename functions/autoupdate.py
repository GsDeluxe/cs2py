...
def get_remote_version():
    ...
    try:
        url = "https://raw.githubusercontent.com/BDadmehr0/cs2py/refs/heads/autoupdate/version.txt"
...
def get_remote_file_list():
    ...
    try:
        api_url = "https://api.github.com/repos/BDadmehr0/cs2py/git/trees/autoupdate?recursive=1"
        ...
        for item in data.get('tree', []):
            if item['type'] == 'blob':
                files.append({
                    'path': item['path'],
                    'url': f"https://raw.githubusercontent.com/BDadmehr0/cs2py/refs/heads/autoupdate/{item['path']}"
                })
...
def update_project():
    ...
    print(f"Update complete: {success_count} updated, {skip_count} unchanged, {fail_count} failed")
    return fail_count == 0
